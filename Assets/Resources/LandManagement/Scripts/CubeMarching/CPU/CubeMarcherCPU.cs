...
{
    public sealed class CubeMarcherCPU : CubeMarcher
    {
        private ConstantBuffer _constantBuffer;
        private Generator _generator;

        public CubeMarcherCPU(LandSettings settings)
        {
            _constantBuffer = new ConstantBuffer
            {
                ...
                pointsHash2EdgesIndexes = new int[,]
            {
                ...
                { 3, 6, 11, 3, 0, 6, 0, 4, 6, 20, 20, 20, 20, 20, 20, 2 },
            ...
            _generator = settings.GeometryType switch
            {
                MarchingGeometryType.Flat => new FlatGenerator(ref _constantBuffer),
                MarchingGeometryType.Planet => new PlanetGenerator(ref _constantBuffer),
