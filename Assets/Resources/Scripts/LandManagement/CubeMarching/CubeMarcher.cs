...
{
    public class CubeMarcher : System.IDisposable
    {
        ...
        public CubeMarcher(LandSettings settings)
        {
        ...
        {
            _cubesPerChunk = settings.CubesPerChunk;
            _pointsPerChunk = settings.PointsPerChunk;
        ...
        protected Mesh DispatchCubesKernel()
        {
