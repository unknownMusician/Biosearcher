...
float GenerateValue(float3 position)
{
    ...
    preMountainNoise *= 1 - GradientNoise(normalizedPosition * _CubesPerChunk * 0.005);
    preMountainNoise *= 1 - GradientNoise(normalizedPosition * _CubesPerChunk * 0.01) * 0.5;
    ...
    preMountainMask *= 1 - GradientNoise(normalizedPosition * _CubesPerChunk * 0.0005);
    preMountainMask *= 1 - GradientNoise(normalizedPosition * _CubesPerChunk * 0.0008);
    preMountainMask *= 1 - GradientNoise(normalizedPosition * _CubesPerChunk * 0.001) * 0.75;
    preMountainMask *= 1 - GradientNoise(normalizedPosition * _CubesPerChunk * 0.002) * 0.5;
    ...
    // Hills
    planetRadius -= GradientNoise(position * _CubesPerChunk * 0.02) /* * (1 - mountainMask)*/ * 0.002;
    planetRadius -= GradientNoise(position * _CubesPerChunk * 0.01) /* * (1 - mountainMask)*/ * 0.005;
    planetRadius -= GradientNoise(position * _CubesPerChunk * 0.005) /* * (1 - mountainMask)*/ * 0.01;
